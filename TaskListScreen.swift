...
struct TaskListsScreen: View {
    ...
    var body: some View {
        List {
            ...
            VStack{
                HStack{
                    TaskStatsView(icon:"calendar", title: "today", count: 7)
                    TaskStatsView(icon:"calendar.circle.fill", title: "hiii", count: 2)
                        .hoverEffect()
                }
                HStack{
                    TaskStatsView(icon:"checkmark.circle.fill", title: "skechule", count: 4)
                    TaskStatsView(icon:"try.circle.fill", title: "All", count: 11)
                }
            }
            HStack {
